        ...
        <div className="grid w-full max-w-6xl items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="hidden lg:block">
            ...
            <p className="mt-5 max-w-lg text-base leading-8 text-[#7a6641]">
              Sign in to track orders, manage your account, save products, and
              continue your premium jersey shopping experience.
            </p>
          </div>
            ...
            <div className="overflow-hidden rounded-[28px] border border-[rgba(201,149,0,0.14)] bg-white/90 p-6 shadow-[0_24px_70px_rgba(201,149,0,0.10)] backdrop-blur-xl sm:p-7">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full rounded-2xl bg-[linear-gradient(135deg,#c99500,#e0b22c)] px-4 py-3.5 text-base font-semibold text-white transition hover:opacity-90 disabled:opacity-70"
                >
                ...
                <div className="text-center">
                  <Link
                    ...
                    className="text-sm font-medium text-[#a87400] transition hover:opacity-80"
                  >
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="my-5 border-t border-[rgba(201,149,0,0.12)]" />

              <div className="text-center">
                <Link
                  href="/signup"
                  className="inline-flex items-center justify-center rounded-xl border border-[rgba(201,149,0,0.14)] bg-[#fffdf7] px-5 py-3 text-sm font-semibold text-[#2b2112] transition hover:border-[rgba(201,149,0,0.32)] hover:text-[#a87400]"
                >
                  Create New Account
                </Link>
              </div>
