  ...
  async function loadCart() {
    ...
    try {
      ...
      if (promoFromUrl) {
        ...
        if (promoRes.ok) {
          setDiscount(Number(promoData.discount || 0));
          setTotal(Number(promoData.total || 0));
        } else {
          setDiscount(0);
          setTotal(cartTotal);
        }
          ...
          <section className="space-y-6">
            ...
            <div className="rounded-[28px] border border-[rgba(201,149,0,0.14)] bg-white shadow-[0_20px_60px_rgba(201,149,0,0.06)] p-6 md:p-8">
              ...
              <div className="flex items-center gap-3 mb-6 pb-6 border-b border-[rgba(201,149,0,0.1)]">
                ...
                <div>
                  <h2 className="text-lg font-bold text-[#2b2112]">
                    Delivery Address
                  </h2>

                  <p className="text-xs text-[#9b8b6f]">
                    Where should we send your jersey?
                  </p>
                </div>
              </div>
